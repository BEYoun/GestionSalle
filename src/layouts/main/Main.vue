...
import Admin from "@/layouts/components/vertical-nav-menu/adminNavMenuItems.js";
import Etudiant from "@/layouts/components/vertical-nav-menu/etudiantNavMenuItems.js";
import Professeur from "@/layouts/components/vertical-nav-menu/professeurNavMenuItems.js";
...
export default {
  ...
  created() {
    ...
    if (this.$store.state.AppActiveUser.userRole === "etudiant") {
      this.navMenuItems = Etudiant;
    }
    if (this.$store.state.AppActiveUser.userRole === "professeur") {
      this.navMenuItems = Professeur;
    }
    const color =
